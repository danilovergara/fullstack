...
class Book(models.Model):
	...
	price = models.FloatField(default=0.0) # The price of the book without taxes
	tax = models.FloatField(default=0.0) # The tax this book is affected
	...
	product_description = models.TextField() # A synopsis for the book
